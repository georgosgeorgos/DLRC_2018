...
class RecordingLoop():
    def __init__(self):
        ...
        self.buffer_data    = {"img":               np.zeros([self.buffer_size] + [FrankaConfig.data.img_size]),
    ...
    def run(self,
        ...
        while True:
            ...
            if self.buffer_counter < self.buffer_size:
                ...
                self.buffer_data["control_recv_time"][self.buffer_counter,:] = self.control_prev_recv_time  #self.control_time
                self.buffer_data["control_fnumber"][self.buffer_counter,:]   = self.control_prev_fnumber  #self.control_time
                ...
                # else:
                fname = name_recording + "_" + self.recording_tag + "_" \
                        + str(recording_serial).zfill(4) + "_" \
                        + str(self.buffer_serial).zfill(4) + ".raw"
...
if __name__ == "__main__":
    ...
    recording_loop.run(IMG_ON = IMG_ON,
                       SYNC_ON = SYNC_ON,
