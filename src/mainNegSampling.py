...
from test_routines.testNegSampling import test
from train_routines.trainNegSampling import train
...
parser.add_argument(
    "--encoder_layer_sizes", type=list, default=[((lidar_input_size + joint_input_size) * n_samples_y), 256, 256]
)
