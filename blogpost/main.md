...
**Classify each data reading as self, background and other using Unsupervised/Semi-Supervised Learning techniques.**

We hypothesized that Unsupervised Machine Learning can deal with the sensing task without relying on geometry and configuration.
